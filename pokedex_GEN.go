...
var pokemonBaseStats = map[int][6]int{
	1:   [6]int{45, 49, 49, 65, 65, 45},
	2:   [6]int{60, 62, 63, 80, 80, 60},
	3:   [6]int{80, 82, 83, 100, 100, 80},
	4:   [6]int{39, 52, 43, 60, 50, 65},
	5:   [6]int{58, 64, 58, 80, 65, 80},
	6:   [6]int{78, 84, 78, 109, 85, 100},
	7:   [6]int{44, 48, 65, 50, 64, 43},
	8:   [6]int{59, 63, 80, 65, 80, 58},
	9:   [6]int{79, 83, 100, 85, 105, 78},
	10:  [6]int{45, 30, 35, 20, 20, 45},
	11:  [6]int{50, 20, 55, 25, 25, 30},
	12:  [6]int{60, 45, 50, 90, 80, 70},
	13:  [6]int{40, 35, 30, 20, 20, 50},
	14:  [6]int{45, 25, 50, 25, 25, 35},
	15:  [6]int{65, 90, 40, 45, 80, 75},
	16:  [6]int{40, 45, 40, 35, 35, 56},
	17:  [6]int{63, 60, 55, 50, 50, 71},
	18:  [6]int{83, 80, 75, 70, 70, 101},
	19:  [6]int{30, 56, 35, 25, 35, 72},
	20:  [6]int{55, 81, 60, 50, 70, 97},
	21:  [6]int{40, 60, 30, 31, 31, 70},
	22:  [6]int{65, 90, 65, 61, 61, 100},
	23:  [6]int{35, 60, 44, 40, 54, 55},
	24:  [6]int{60, 95, 69, 65, 79, 80},
	25:  [6]int{35, 55, 40, 50, 50, 90},
	26:  [6]int{60, 90, 55, 90, 80, 110},
	27:  [6]int{50, 75, 85, 20, 30, 40},
	28:  [6]int{75, 100, 110, 45, 55, 65},
	29:  [6]int{55, 47, 52, 40, 40, 41},
	30:  [6]int{70, 62, 67, 55, 55, 56},
	31:  [6]int{90, 92, 87, 75, 85, 76},
	32:  [6]int{46, 57, 40, 40, 40, 50},
	33:  [6]int{61, 72, 57, 55, 55, 65},
	34:  [6]int{81, 102, 77, 85, 75, 85},
	35:  [6]int{70, 45, 48, 60, 65, 35},
	36:  [6]int{95, 70, 73, 95, 90, 60},
	37:  [6]int{38, 41, 40, 50, 65, 65},
	38:  [6]int{73, 76, 75, 81, 100, 100},
	39:  [6]int{115, 45, 20, 45, 25, 20},
	40:  [6]int{140, 70, 45, 85, 50, 45},
	41:  [6]int{40, 45, 35, 30, 40, 55},
	42:  [6]int{75, 80, 70, 65, 75, 90},
	43:  [6]int{45, 50, 55, 75, 65, 30},
	44:  [6]int{60, 65, 70, 85, 75, 40},
	45:  [6]int{75, 80, 85, 110, 90, 50},
	46:  [6]int{35, 70, 55, 45, 55, 25},
	47:  [6]int{60, 95, 80, 60, 80, 30},
	48:  [6]int{60, 55, 50, 40, 55, 45},
	49:  [6]int{70, 65, 60, 90, 75, 90},
	50:  [6]int{10, 55, 25, 35, 45, 95},
	51:  [6]int{35, 100, 50, 50, 70, 120},
	52:  [6]int{40, 45, 35, 40, 40, 90},
	53:  [6]int{65, 70, 60, 65, 65, 115},
	54:  [6]int{50, 52, 48, 65, 50, 55},
	55:  [6]int{80, 82, 78, 95, 80, 85},
	56:  [6]int{40, 80, 35, 35, 45, 70},
	57:  [6]int{65, 105, 60, 60, 70, 95},
	58:  [6]int{55, 70, 45, 70, 50, 60},
	59:  [6]int{90, 110, 80, 100, 80, 95},
	60:  [6]int{40, 50, 40, 40, 40, 90},
	61:  [6]int{65, 65, 65, 50, 50, 90},
	62:  [6]int{90, 95, 95, 70, 90, 70},
	63:  [6]int{25, 20, 15, 105, 55, 90},
	64:  [6]int{40, 35, 30, 120, 70, 105},
	65:  [6]int{55, 50, 45, 135, 95, 120},
	66:  [6]int{70, 80, 50, 35, 35, 35},
	67:  [6]int{80, 100, 70, 50, 60, 45},
	68:  [6]int{90, 130, 80, 65, 85, 55},
	69:  [6]int{50, 75, 35, 70, 30, 40},
	70:  [6]int{65, 90, 50, 85, 45, 55},
	71:  [6]int{80, 105, 65, 100, 70, 70},
	72:  [6]int{40, 40, 35, 50, 100, 70},
	73:  [6]int{80, 70, 65, 80, 120, 100},
	74:  [6]int{40, 80, 100, 30, 30, 20},
	75:  [6]int{55, 95, 115, 45, 45, 35},
	76:  [6]int{80, 120, 130, 55, 65, 45},
	77:  [6]int{50, 85, 55, 65, 65, 90},
	78:  [6]int{65, 100, 70, 80, 80, 105},
	79:  [6]int{90, 65, 65, 40, 40, 15},
	80:  [6]int{95, 75, 110, 100, 80, 30},
	81:  [6]int{25, 35, 70, 95, 55, 45},
	82:  [6]int{50, 60, 95, 120, 70, 70},
	83:  [6]int{52, 90, 55, 58, 62, 60},
	84:  [6]int{35, 85, 45, 35, 35, 75},
	85:  [6]int{60, 110, 70, 60, 60, 110},
	86:  [6]int{65, 45, 55, 45, 70, 45},
	87:  [6]int{90, 70, 80, 70, 95, 70},
	88:  [6]int{80, 80, 50, 40, 50, 25},
	89:  [6]int{105, 105, 75, 65, 100, 50},
	90:  [6]int{30, 65, 100, 45, 25, 40},
	91:  [6]int{50, 95, 180, 85, 45, 70},
	92:  [6]int{30, 35, 30, 100, 35, 80},
	93:  [6]int{45, 50, 45, 115, 55, 95},
	94:  [6]int{60, 65, 60, 130, 75, 110},
	95:  [6]int{35, 45, 160, 30, 45, 70},
	96:  [6]int{60, 48, 45, 43, 90, 42},
	97:  [6]int{85, 73, 70, 73, 115, 67},
	98:  [6]int{30, 105, 90, 25, 25, 50},
	99:  [6]int{55, 130, 115, 50, 50, 75},
	100: [6]int{40, 30, 50, 55, 55, 100},
	101: [6]int{60, 50, 70, 80, 80, 150},
	102: [6]int{60, 40, 80, 60, 45, 40},
	103: [6]int{95, 95, 85, 125, 75, 55},
	104: [6]int{50, 50, 95, 40, 50, 35},
	105: [6]int{60, 80, 110, 50, 80, 45},
	106: [6]int{50, 120, 53, 35, 110, 87},
	107: [6]int{50, 105, 79, 35, 110, 76},
	108: [6]int{90, 55, 75, 60, 75, 30},
	109: [6]int{40, 65, 95, 60, 45, 35},
	110: [6]int{65, 90, 120, 85, 70, 60},
	111: [6]int{80, 85, 95, 30, 30, 25},
	112: [6]int{105, 130, 120, 45, 45, 40},
	113: [6]int{250, 5, 5, 35, 105, 50},
	114: [6]int{65, 55, 115, 100, 40, 60},
	115: [6]int{105, 95, 80, 40, 80, 90},
	116: [6]int{30, 40, 70, 70, 25, 60},
	117: [6]int{55, 65, 95, 95, 45, 85},
	118: [6]int{45, 67, 60, 35, 50, 63},
	119: [6]int{80, 92, 65, 65, 80, 68},
	120: [6]int{30, 45, 55, 70, 55, 85},
	121: [6]int{60, 75, 85, 100, 85, 115},
	122: [6]int{40, 45, 65, 100, 120, 90},
	123: [6]int{70, 110, 80, 55, 80, 105},
	124: [6]int{65, 50, 35, 115, 95, 95},
	125: [6]int{65, 83, 57, 95, 85, 105},
	126: [6]int{65, 95, 57, 100, 85, 93},
	127: [6]int{65, 125, 100, 55, 70, 85},
	128: [6]int{75, 100, 95, 40, 70, 110},
	129: [6]int{20, 10, 55, 15, 20, 80},
	130: [6]int{95, 125, 79, 60, 100, 81},
	131: [6]int{130, 85, 80, 85, 95, 60},
	132: [6]int{48, 48, 48, 48, 48, 48},
	133: [6]int{55, 55, 50, 45, 65, 55},
	134: [6]int{130, 65, 60, 110, 95, 65},
	135: [6]int{65, 65, 60, 110, 95, 130},
	136: [6]int{65, 130, 60, 95, 110, 65},
	137: [6]int{65, 60, 70, 85, 75, 40},
	138: [6]int{35, 40, 100, 90, 55, 35},
	139: [6]int{70, 60, 125, 115, 70, 55},
	140: [6]int{30, 80, 90, 55, 45, 55},
	141: [6]int{60, 115, 105, 65, 70, 80},
	142: [6]int{80, 105, 65, 60, 75, 130},
	143: [6]int{160, 110, 65, 65, 110, 30},
	144: [6]int{90, 85, 100, 95, 125, 85},
	145: [6]int{90, 90, 85, 125, 90, 100},
	146: [6]int{90, 100, 90, 125, 85, 90},
	147: [6]int{41, 64, 45, 50, 50, 50},
	148: [6]int{61, 84, 65, 70, 70, 70},
	149: [6]int{91, 134, 95, 100, 100, 80},
	150: [6]int{106, 110, 90, 154, 90, 130},
	151: [6]int{100, 100, 100, 100, 100, 100},
	152: [6]int{45, 49, 65, 49, 65, 45},
	153: [6]int{60, 62, 80, 63, 80, 60},
	154: [6]int{80, 82, 100, 83, 100, 80},
	155: [6]int{39, 52, 43, 60, 50, 65},
	156: [6]int{58, 64, 58, 80, 65, 80},
	157: [6]int{78, 84, 78, 109, 85, 100},
	158: [6]int{50, 65, 64, 44, 48, 43},
	159: [6]int{65, 80, 80, 59, 63, 58},
	160: [6]int{85, 105, 100, 79, 83, 78},
	161: [6]int{35, 46, 34, 35, 45, 20},
	162: [6]int{85, 76, 64, 45, 55, 90},
	163: [6]int{60, 30, 30, 36, 56, 50},
	164: [6]int{100, 50, 50, 86, 96, 70},
	165: [6]int{40, 20, 30, 40, 80, 55},
	166: [6]int{55, 35, 50, 55, 110, 85},
	167: [6]int{40, 60, 40, 40, 40, 30},
	168: [6]int{70, 90, 70, 60, 70, 40},
	169: [6]int{85, 90, 80, 70, 80, 130},
	170: [6]int{75, 38, 38, 56, 56, 67},
	171: [6]int{125, 58, 58, 76, 76, 67},
	172: [6]int{20, 40, 15, 35, 35, 60},
	173: [6]int{50, 25, 28, 45, 55, 15},
	174: [6]int{90, 30, 15, 40, 20, 15},
	175: [6]int{35, 20, 65, 40, 65, 20},
	176: [6]int{55, 40, 85, 80, 105, 40},
	177: [6]int{40, 50, 45, 70, 45, 70},
	178: [6]int{65, 75, 70, 95, 70, 95},
	179: [6]int{55, 40, 40, 65, 45, 35},
	180: [6]int{70, 55, 55, 80, 60, 45},
	181: [6]int{90, 75, 85, 115, 90, 55},
	182: [6]int{75, 80, 95, 90, 100, 50},
	183: [6]int{70, 20, 50, 20, 50, 40},
	184: [6]int{100, 50, 80, 60, 80, 50},
	185: [6]int{70, 100, 115, 30, 65, 30},
	186: [6]int{90, 75, 75, 90, 100, 70},
	187: [6]int{35, 35, 40, 35, 55, 50},
	188: [6]int{55, 45, 50, 45, 65, 80},
	189: [6]int{75, 55, 70, 55, 95, 110},
	190: [6]int{55, 70, 55, 40, 55, 85},
	191: [6]int{30, 30, 30, 30, 30, 30},
	192: [6]int{75, 75, 55, 105, 85, 30},
	193: [6]int{65, 65, 45, 75, 45, 95},
	194: [6]int{55, 45, 45, 25, 25, 15},
	195: [6]int{95, 85, 85, 65, 65, 35},
	196: [6]int{65, 65, 60, 130, 95, 110},
	197: [6]int{95, 65, 110, 60, 130, 65},
	198: [6]int{60, 85, 42, 85, 42, 91},
	199: [6]int{95, 75, 80, 100, 110, 30},
	200: [6]int{60, 60, 60, 85, 85, 85},
	201: [6]int{48, 72, 48, 72, 48, 48},
	202: [6]int{190, 33, 58, 33, 58, 33},
	203: [6]int{70, 80, 65, 90, 65, 85},
	204: [6]int{50, 65, 90, 35, 35, 15},
	205: [6]int{75, 90, 140, 60, 60, 40},
	206: [6]int{100, 70, 70, 65, 65, 45},
	207: [6]int{65, 75, 105, 35, 65, 85},
	208: [6]int{75, 85, 200, 55, 65, 30},
	209: [6]int{60, 80, 50, 40, 40, 30},
	210: [6]int{90, 120, 75, 60, 60, 45},
	211: [6]int{65, 95, 85, 55, 55, 85},
	212: [6]int{70, 130, 100, 55, 80, 65},
	213: [6]int{20, 10, 230, 10, 230, 5},
	214: [6]int{80, 125, 75, 40, 95, 85},
	215: [6]int{55, 95, 55, 35, 75, 115},
	216: [6]int{60, 80, 50, 50, 50, 40},
	217: [6]int{90, 130, 75, 75, 75, 55},
	218: [6]int{40, 40, 40, 70, 40, 20},
	219: [6]int{60, 50, 120, 90, 80, 30},
	220: [6]int{50, 50, 40, 30, 30, 50},
	221: [6]int{100, 100, 80, 60, 60, 50},
	222: [6]int{65, 55, 95, 65, 95, 35},
	223: [6]int{35, 65, 35, 65, 35, 65},
	224: [6]int{75, 105, 75, 105, 75, 45},
	225: [6]int{45, 55, 45, 65, 45, 75},
	226: [6]int{85, 40, 70, 80, 140, 70},
	227: [6]int{65, 80, 140, 40, 70, 70},
	228: [6]int{45, 60, 30, 80, 50, 65},
	229: [6]int{75, 90, 50, 110, 80, 95},
	230: [6]int{75, 95, 95, 95, 95, 85},
	231: [6]int{90, 60, 60, 40, 40, 40},
	232: [6]int{90, 120, 120, 60, 60, 50},
	233: [6]int{85, 80, 90, 105, 95, 60},
	234: [6]int{73, 95, 62, 85, 65, 85},
	235: [6]int{55, 20, 35, 20, 45, 75},
	236: [6]int{35, 35, 35, 35, 35, 35},
	237: [6]int{50, 95, 95, 35, 110, 70},
	238: [6]int{45, 30, 15, 85, 65, 65},
	239: [6]int{45, 63, 37, 65, 55, 95},
	240: [6]int{45, 75, 37, 70, 55, 83},
	241: [6]int{95, 80, 105, 40, 70, 100},
	242: [6]int{255, 10, 10, 75, 135, 55},
	243: [6]int{90, 85, 75, 115, 100, 115},
	244: [6]int{115, 115, 85, 90, 75, 100},
	245: [6]int{100, 75, 115, 90, 115, 85},
	246: [6]int{50, 64, 50, 45, 50, 41},
	247: [6]int{70, 84, 70, 65, 70, 51},
	248: [6]int{100, 134, 110, 95, 100, 61},
	249: [6]int{106, 90, 130, 90, 154, 110},
	250: [6]int{106, 130, 90, 110, 154, 90},
	251: [6]int{100, 100, 100, 100, 100, 100},
	252: [6]int{40, 45, 35, 65, 55, 70},
	253: [6]int{50, 65, 45, 85, 65, 95},
	254: [6]int{70, 85, 65, 105, 85, 120},
	255: [6]int{45, 60, 40, 70, 50, 45},
	256: [6]int{60, 85, 60, 85, 60, 55},
	257: [6]int{80, 120, 70, 110, 70, 80},
	258: [6]int{50, 70, 50, 50, 50, 40},
	259: [6]int{70, 85, 70, 60, 70, 50},
	260: [6]int{100, 110, 90, 85, 90, 60},
	261: [6]int{35, 55, 35, 30, 30, 35},
	262: [6]int{70, 90, 70, 60, 60, 70},
	263: [6]int{38, 30, 41, 30, 41, 60},
	264: [6]int{78, 70, 61, 50, 61, 100},
	265: [6]int{45, 45, 35, 20, 30, 20},
	266: [6]int{50, 35, 55, 25, 25, 15},
	267: [6]int{60, 70, 50, 100, 50, 65},
	268: [6]int{50, 35, 55, 25, 25, 15},
	269: [6]int{60, 50, 70, 50, 90, 65},
	270: [6]int{40, 30, 30, 40, 50, 30},
	271: [6]int{60, 50, 50, 60, 70, 50},
	272: [6]int{80, 70, 70, 90, 100, 70},
	273: [6]int{40, 40, 50, 30, 30, 30},
	274: [6]int{70, 70, 40, 60, 40, 60},
	275: [6]int{90, 100, 60, 90, 60, 80},
	276: [6]int{40, 55, 30, 30, 30, 85},
	277: [6]int{60, 85, 60, 75, 50, 125},
	278: [6]int{40, 30, 30, 55, 30, 85},
	279: [6]int{60, 50, 100, 95, 70, 65},
	280: [6]int{28, 25, 25, 45, 35, 40},
	281: [6]int{38, 35, 35, 65, 55, 50},
	282: [6]int{68, 65, 65, 125, 115, 80},
	283: [6]int{40, 30, 32, 50, 52, 65},
	284: [6]int{70, 60, 62, 100, 82, 80},
	285: [6]int{60, 40, 60, 40, 60, 35},
	286: [6]int{60, 130, 80, 60, 60, 70},
	287: [6]int{60, 60, 60, 35, 35, 30},
	288: [6]int{80, 80, 80, 55, 55, 90},
	289: [6]int{150, 160, 100, 95, 65, 100},
	290: [6]int{31, 45, 90, 30, 30, 40},
	291: [6]int{61, 90, 45, 50, 50, 160},
	292: [6]int{1, 90, 45, 30, 30, 40},
	293: [6]int{64, 51, 23, 51, 23, 28},
	294: [6]int{84, 71, 43, 71, 43, 48},
	295: [6]int{104, 91, 63, 91, 73, 68},
	296: [6]int{72, 60, 30, 20, 30, 25},
	297: [6]int{144, 120, 60, 40, 60, 50},
	298: [6]int{50, 20, 40, 20, 40, 20},
	299: [6]int{30, 45, 135, 45, 90, 30},
	300: [6]int{50, 45, 45, 35, 35, 50},
	301: [6]int{70, 65, 65, 55, 55, 90},
	302: [6]int{50, 75, 75, 65, 65, 50},
	303: [6]int{50, 85, 85, 55, 55, 50},
	304: [6]int{50, 70, 100, 40, 40, 30},
	305: [6]int{60, 90, 140, 50, 50, 40},
	306: [6]int{70, 110, 180, 60, 60, 50},
	307: [6]int{30, 40, 55, 40, 55, 60},
	308: [6]int{60, 60, 75, 60, 75, 80},
	309: [6]int{40, 45, 40, 65, 40, 65},
	310: [6]int{70, 75, 60, 105, 60, 105},
	311: [6]int{60, 50, 40, 85, 75, 95},
	312: [6]int{60, 40, 50, 75, 85, 95},
	313: [6]int{65, 73, 75, 47, 85, 85},
	314: [6]int{65, 47, 75, 73, 85, 85},
	315: [6]int{50, 60, 45, 100, 80, 65},
	316: [6]int{70, 43, 53, 43, 53, 40},
	317: [6]int{100, 73, 83, 73, 83, 55},
	318: [6]int{45, 90, 20, 65, 20, 65},
	319: [6]int{70, 120, 40, 95, 40, 95},
	320: [6]int{130, 70, 35, 70, 35, 60},
	321: [6]int{170, 90, 45, 90, 45, 60},
	322: [6]int{60, 60, 40, 65, 45, 35},
	323: [6]int{70, 100, 70, 105, 75, 40},
	324: [6]int{70, 85, 140, 85, 70, 20},
	325: [6]int{60, 25, 35, 70, 80, 60},
	326: [6]int{80, 45, 65, 90, 110, 80},
	327: [6]int{60, 60, 60, 60, 60, 60},
	328: [6]int{45, 100, 45, 45, 45, 10},
	329: [6]int{50, 70, 50, 50, 50, 70},
	330: [6]int{80, 100, 80, 80, 80, 100},
	331: [6]int{50, 85, 40, 85, 40, 35},
	332: [6]int{70, 115, 60, 115, 60, 55},
	333: [6]int{45, 40, 60, 40, 75, 50},
	334: [6]int{75, 70, 90, 70, 105, 80},
	335: [6]int{73, 115, 60, 60, 60, 90},
	336: [6]int{73, 100, 60, 100, 60, 65},
	337: [6]int{90, 55, 65, 95, 85, 70},
	338: [6]int{90, 95, 85, 55, 65, 70},
	339: [6]int{50, 48, 43, 46, 41, 60},
	340: [6]int{110, 78, 73, 76, 71, 60},
	341: [6]int{43, 80, 65, 50, 35, 35},
	342: [6]int{63, 120, 85, 90, 55, 55},
	343: [6]int{40, 40, 55, 40, 70, 55},
	344: [6]int{60, 70, 105, 70, 120, 75},
	345: [6]int{66, 41, 77, 61, 87, 23},
	346: [6]int{86, 81, 97, 81, 107, 43},
	347: [6]int{45, 95, 50, 40, 50, 75},
	348: [6]int{75, 125, 100, 70, 80, 45},
	349: [6]int{20, 15, 20, 10, 55, 80},
	350: [6]int{95, 60, 79, 100, 125, 81},
	351: [6]int{70, 70, 70, 70, 70, 70},
	352: [6]int{60, 90, 70, 60, 120, 40},
	353: [6]int{44, 75, 35, 63, 33, 45},
	354: [6]int{64, 115, 65, 83, 63, 65},
	355: [6]int{20, 40, 90, 30, 90, 25},
	356: [6]int{40, 70, 130, 60, 130, 25},
	357: [6]int{99, 68, 83, 72, 87, 51},
	358: [6]int{75, 50, 80, 95, 90, 65},
	359: [6]int{65, 130, 60, 75, 60, 75},
	360: [6]int{95, 23, 48, 23, 48, 23},
	361: [6]int{50, 50, 50, 50, 50, 50},
	362: [6]int{80, 80, 80, 80, 80, 80},
	363: [6]int{70, 40, 50, 55, 50, 25},
	364: [6]int{90, 60, 70, 75, 70, 45},
	365: [6]int{110, 80, 90, 95, 90, 65},
	366: [6]int{35, 64, 85, 74, 55, 32},
	367: [6]int{55, 104, 105, 94, 75, 52},
	368: [6]int{55, 84, 105, 114, 75, 52},
	369: [6]int{100, 90, 130, 45, 65, 55},
	370: [6]int{43, 30, 55, 40, 65, 97},
	371: [6]int{45, 75, 60, 40, 30, 50},
	372: [6]int{65, 95, 100, 60, 50, 50},
	373: [6]int{95, 135, 80, 110, 80, 100},
	374: [6]int{40, 55, 80, 35, 60, 30},
	375: [6]int{60, 75, 100, 55, 80, 50},
	376: [6]int{80, 135, 130, 95, 90, 70},
	377: [6]int{80, 100, 200, 50, 100, 50},
	378: [6]int{80, 50, 100, 100, 200, 50},
	379: [6]int{80, 75, 150, 75, 150, 50},
	380: [6]int{80, 80, 90, 110, 130, 110},
	381: [6]int{80, 90, 80, 130, 110, 110},
	382: [6]int{100, 100, 90, 150, 140, 90},
	383: [6]int{100, 150, 140, 100, 90, 90},
	384: [6]int{105, 150, 90, 150, 90, 95},
	385: [6]int{100, 100, 100, 100, 100, 100},
	386: [6]int{50, 150, 50, 150, 50, 150},
	387: [6]int{55, 68, 64, 45, 55, 31},
	388: [6]int{75, 89, 85, 55, 65, 36},
	389: [6]int{95, 109, 105, 75, 85, 56},
	390: [6]int{44, 58, 44, 58, 44, 61},
	391: [6]int{64, 78, 52, 78, 52, 81},
	392: [6]int{76, 104, 71, 104, 71, 108},
	393: [6]int{53, 51, 53, 61, 56, 40},
	394: [6]int{64, 66, 68, 81, 76, 50},
	395: [6]int{84, 86, 88, 111, 101, 60},
	396: [6]int{40, 55, 30, 30, 30, 60},
	397: [6]int{55, 75, 50, 40, 40, 80},
	398: [6]int{85, 120, 70, 50, 60, 100},
	399: [6]int{59, 45, 40, 35, 40, 31},
	400: [6]int{79, 85, 60, 55, 60, 71},
	401: [6]int{37, 25, 41, 25, 41, 25},
	402: [6]int{77, 85, 51, 55, 51, 65},
	403: [6]int{45, 65, 34, 40, 34, 45},
	404: [6]int{60, 85, 49, 60, 49, 60},
	405: [6]int{80, 120, 79, 95, 79, 70},
	406: [6]int{40, 30, 35, 50, 70, 55},
	407: [6]int{60, 70, 65, 125, 105, 90},
	408: [6]int{67, 125, 40, 30, 30, 58},
	409: [6]int{97, 165, 60, 65, 50, 58},
	410: [6]int{30, 42, 118, 42, 88, 30},
	411: [6]int{60, 52, 168, 47, 138, 30},
	412: [6]int{40, 29, 45, 29, 45, 36},
	413: [6]int{60, 59, 85, 79, 105, 36},
	414: [6]int{70, 94, 50, 94, 50, 66},
	415: [6]int{30, 30, 42, 30, 42, 70},
	416: [6]int{70, 80, 102, 80, 102, 40},
	417: [6]int{60, 45, 70, 45, 90, 95},
	418: [6]int{55, 65, 35, 60, 30, 85},
	419: [6]int{85, 105, 55, 85, 50, 115},
	420: [6]int{45, 35, 45, 62, 53, 35},
	421: [6]int{70, 60, 70, 87, 78, 85},
	422: [6]int{76, 48, 48, 57, 62, 34},
	423: [6]int{111, 83, 68, 92, 82, 39},
	424: [6]int{75, 100, 66, 60, 66, 115},
	425: [6]int{90, 50, 34, 60, 44, 70},
	426: [6]int{150, 80, 44, 90, 54, 80},
	427: [6]int{55, 66, 44, 44, 56, 85},
	428: [6]int{65, 76, 84, 54, 96, 105},
	429: [6]int{60, 60, 60, 105, 105, 105},
	430: [6]int{100, 125, 52, 105, 52, 71},
	431: [6]int{49, 55, 42, 42, 37, 85},
	432: [6]int{71, 82, 64, 64, 59, 112},
	433: [6]int{45, 30, 50, 65, 50, 45},
	434: [6]int{63, 63, 47, 41, 41, 74},
	435: [6]int{103, 93, 67, 71, 61, 84},
	436: [6]int{57, 24, 86, 24, 86, 23},
	437: [6]int{67, 89, 116, 79, 116, 33},
	438: [6]int{50, 80, 95, 10, 45, 10},
	439: [6]int{20, 25, 45, 70, 90, 60},
	440: [6]int{100, 5, 5, 15, 65, 30},
	441: [6]int{76, 65, 45, 92, 42, 91},
	442: [6]int{50, 92, 108, 92, 108, 35},
	443: [6]int{58, 70, 45, 40, 45, 42},
	444: [6]int{68, 90, 65, 50, 55, 82},
	445: [6]int{108, 130, 95, 80, 85, 102},
	446: [6]int{135, 85, 40, 40, 85, 5},
	447: [6]int{40, 70, 40, 35, 40, 60},
	448: [6]int{70, 110, 70, 115, 70, 90},
	449: [6]int{68, 72, 78, 38, 42, 32},
	450: [6]int{108, 112, 118, 68, 72, 47},
	451: [6]int{40, 50, 90, 30, 55, 65},
	452: [6]int{70, 90, 110, 60, 75, 95},
	453: [6]int{48, 61, 40, 61, 40, 50},
	454: [6]int{83, 106, 65, 86, 65, 85},
	455: [6]int{74, 100, 72, 90, 72, 46},
	456: [6]int{49, 49, 56, 49, 61, 66},
	457: [6]int{69, 69, 76, 69, 86, 91},
	458: [6]int{45, 20, 50, 60, 120, 50},
	459: [6]int{60, 62, 50, 62, 60, 40},
	460: [6]int{90, 92, 75, 92, 85, 60},
	461: [6]int{70, 120, 65, 45, 85, 125},
	462: [6]int{70, 70, 115, 130, 90, 60},
	463: [6]int{110, 85, 95, 80, 95, 50},
	464: [6]int{115, 140, 130, 55, 55, 40},
	465: [6]int{100, 100, 125, 110, 50, 50},
	466: [6]int{75, 123, 67, 95, 85, 95},
	467: [6]int{75, 95, 67, 125, 95, 83},
	468: [6]int{85, 50, 95, 120, 115, 80},
	469: [6]int{86, 76, 86, 116, 56, 95},
	470: [6]int{65, 110, 130, 60, 65, 95},
	471: [6]int{65, 60, 110, 130, 95, 65},
	472: [6]int{75, 95, 125, 45, 75, 95},
	473: [6]int{110, 130, 80, 70, 60, 80},
	474: [6]int{85, 80, 70, 135, 75, 90},
	475: [6]int{68, 125, 65, 65, 115, 80},
	476: [6]int{60, 55, 145, 75, 150, 40},
	477: [6]int{45, 100, 135, 65, 135, 45},
	478: [6]int{70, 80, 70, 80, 70, 110},
	479: [6]int{50, 50, 77, 95, 77, 91},
	480: [6]int{75, 75, 130, 75, 130, 95},
	481: [6]int{80, 105, 105, 105, 105, 80},
	482: [6]int{75, 125, 70, 125, 70, 115},
	483: [6]int{100, 120, 120, 150, 100, 90},
	484: [6]int{90, 120, 100, 150, 120, 100},
	485: [6]int{91, 90, 106, 130, 106, 77},
	486: [6]int{110, 160, 110, 80, 110, 100},
	487: [6]int{150, 100, 120, 100, 120, 90},
	488: [6]int{120, 70, 120, 75, 130, 85},
	489: [6]int{80, 80, 80, 80, 80, 80},
	490: [6]int{100, 100, 100, 100, 100, 100},
	491: [6]int{70, 90, 90, 135, 90, 125},
	492: [6]int{100, 100, 100, 100, 100, 100},
	493: [6]int{120, 120, 120, 120, 120, 120},
}
